...
public:
  ...
  //{{{
  {
    ...
    static i4_float px[] = {     0 , -0.05f, +0.05f, -0.05f, +0.05f,     0  };
    static i4_float py[] = { -0.03f, +0.03f, +0.03f, -0.03f, -0.03f, +0.03f };
    ...
    l2w.transform(p,pos);
    l2w.transform_3x3(i4_3d_point_class(0.4f,px[missiles],py[missiles]),dir);
  ...
  //{{{
  {
    ...
    else
    {
      ...
      if (guard_time<=0)
      {
        ...
        guard_pitch = (-g1_float_rand(2)*0.5f + 0.25f)*i4_pi();
        i4_normalize_angle(guard_pitch);
        guard_time = 20;
      }
