...
class i4_debug_message_device_class :
	public i4_device_class
{


public:
	i4_debug_message_device_class() :
		i4_device_class()
	{
	};
	...
	{
		static_name(buffer,"Debug Message Device");
	}
...
class g1_send_debug_message_class :
...
public:
	...
	{
		return new g1_send_debug_message_class(msg);
	}
};
