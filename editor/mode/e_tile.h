...
public:
	...
	g1_rotation_type get_cell_rotation()
	{
		return current_cell_rotation;
	}
	void set_cell_rotation(g1_rotation_type rot)
	{
		current_cell_rotation=rot;
		refresh_picker();
	}

	i4_bool get_mirrored()
	{
		return mirrored;
	}
	void set_mirrored(i4_bool value)
	{
		mirrored=value;
		refresh_picker();
	}
