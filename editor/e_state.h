...
public:
	...
	{
		return new g1_set_major_mode_event(name);
	}
};


class g1_set_minor_mode_event :
	public g1_set_major_mode_event
{
public:
	w32 minor_mode;
	...
	virtual i4_event *copy()
	{
		return new g1_set_minor_mode_event(name, minor_mode);
	}
};
...
public:
	enum {
		NO_SNAP, SNAP_CENTER, SNAP_ORIGIN
	} snap;
