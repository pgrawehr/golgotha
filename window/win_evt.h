...
class i4_window_got_mouse_focus_class :
...
public:
	...
	virtual i4_event *copy()
	{
		return new i4_window_got_mouse_focus_class(from_window,x,y);
	}
};


class i4_window_lost_mouse_focus_class :
	public i4_window_message_class
{
public:
	...
	virtual i4_event *copy()
	{
		return new i4_window_lost_mouse_focus_class(from_window, lost_to);
	}
};

class i4_window_request_drag_drop_end_class :
	public i4_window_message_class
{
public:
...
class i4_window_drag_drop_move_class :
	public i4_window_message_class
{
public:
	i4_coord x,y;
...
class i4_window_request_drag_drop_start_class :
	public i4_window_message_class
{
public:
...
class i4_window_got_drag_drop_focus_class :
	public i4_window_message_class
{
public:
...
class i4_window_got_drop_class :
	public i4_window_message_class
{
public:
	i4_drag_info_struct drag_info;
...
class i4_window_lost_drag_drop_focus_class :
	public i4_window_message_class
{
public:
...
// return_result is set to i4_T if the parent was able to give you mouse grabbing
class i4_window_request_key_grab_class :
	public i4_window_message_class
{
public:
	i4_bool return_result;
	...
	virtual i4_event *copy()
	{
		return new i4_window_request_key_grab_class(from_window);
	}
	virtual dispatch_time when()
	{
		return NOW;
...
// return_result is set to i4_T if the parent was able to give you mouse grabbing
class i4_window_request_mouse_grab_class :
	public i4_window_message_class
{
public:
	i4_bool return_result;
...
// return_result is set to i4_T if the parent was able to give you mouse grabbing
class i4_window_request_mouse_ungrab_class :
	public i4_window_message_class
{
public:
	i4_bool return_result;
	...
	virtual i4_event *copy()
	{
		return new i4_window_request_mouse_ungrab_class(from_window);
	}
	virtual dispatch_time when()
	{
		return NOW;
...
class i4_window_request_drag_start_class :
	public i4_window_message_class
{
public:
	i4_bool return_result;
...
// return_result is set to i4_T if the parent was able to start dragging
class i4_window_request_drag_end_class :
	public i4_window_message_class
{
public:
...
class i4_window_change_cursor_class :
	public i4_window_message_class
{
public:
...
class i4_window_notify_resize_class :
	public i4_window_message_class
{
public:
...
class i4_window_notify_redepth_class :
	public i4_window_message_class
{
public:
	w16 new_bitdepth;
...
class i4_window_notify_move_class :
	public i4_window_message_class
{
public:
