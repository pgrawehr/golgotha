...
public:
	...
	i4_coord last_mouse_x() const
	{
		return mouse_x;
	}
	i4_coord last_mouse_y() const
	{
		return mouse_y;
	}
	i4_coord prev_mouse_x() const
	{
		return last_x;
	}
	i4_coord prev_mouse_y() const
	{
		return last_y;
	}
	...
	i4_parent_window_class *get_parent()
	{
		return parent;
	}
