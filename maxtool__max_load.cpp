...
class m1_poly_object_loader_class :
	public g1_quad_object_loader_class
{
public:
	m1_poly_object_class *mobj() const
	{
		return (m1_poly_object_class *)obj;
	}
	...
	//{{{
	{
		...
		}                      //i4_str behaves unpredictably if ptr=0.
		else
		{
			n=new i4_str(name);
		}

		mobj()->animation_names[anim]=n;
	}
	//}}}
	...
	//}}}
	//BSPCODE
	//This would be a good place to add some additional virtual functions
	//like the above create_mount_point() etc. to actually add the bsp data to
	//the object.
};
					   ...
					   r1_texture_manager_class *tman)
{
	...
	{
		i4_alert(i4gets("obj_missing"),100,&object_filename);
	}
