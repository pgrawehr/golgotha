...
# Golgotha Makefile for linux native build using gcc 3.3
...
LIBS= -lm -lX11 -lGL -lGLU -lpthread 
...
#these flags work for real linux
CFLAGS= $(INCDIRS) -x c++ -D __linux -W -Wcast-qual \
	-ffor-scope -fms-extensions -Wno-non-template-friend 
...
all:	depend prereq golgotha.elf
