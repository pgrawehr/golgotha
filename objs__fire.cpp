...
S1_SFX(supergun_fire, "fire/big_bertha_gun_fire_22khz.wav", S1_STREAMED, 200);
                         ...
                         g1_object_class *last_object_fired)
{
  ...
  else if (fire_type==chain_gun.get())
  {
    ...
    float spread=0.1f, spread_sub=0.05f;
  ...
  {
    //if (who_firing_at)  
    //setup must always be called. It is responsible for occupy_location()
