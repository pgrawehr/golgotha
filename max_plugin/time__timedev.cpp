...
class i4_time_device_adder_class :
...
void i4_profile_report(char *filename)
{
	...
	if (fp)
	{
		...
		for (i=0; i<t; i++)
		{
			double percent= (double)((signed __int64)plist[i]->total_time * oo_total);
			double t_clocks=(double)((signed __int64)plist[i]->total_time);
