...
public:
	...
	class rotate_left_modifier :
		public property_modifier
	{
public:
...
public:
	...
	class reverse_texture_modifier :
		public property_modifier
	{
public:
		virtual void modify(prop_list &p)
...
public:
	...
	class set_trans_texture_modifier :
		public property_modifier
	{
public:
		virtual void modify(prop_list &p)
...
class m1_utility_descriptor_class :
	public ClassDesc
{
public:
	int           IsPublic()
	...
	Class_ID      ClassID()
	{
		return Class_ID(0x34713748, 0x5b4c1417);
	}
...
ClassDesc *GetCrackUtilDesc()
{
	return &m1_utility_descriptor;
}
