		...
		switch (size_picker->get_current())
		{
			case 0:
				...
				sprintf(str+strlen(str),
						"Small Installation does not have music");
				break;
				break;
			...
			case 1:
				...
				sprintf(str+strlen(str),
						"Large Installation has the best of everything");
				break;
				break;
		}
...
li_object *copy_file(li_object *o, li_environment *env)
{
	...
	while (size<tot)
	{
		...
		{
			error_win->printf("Couldn't write target, out of disk space?\n");
			return 0;
		}
