...
class li_g1_sky_function:public li_type_function_table
	{
	public: 
...
void g1_sky_view::draw(i4_draw_context_class &context)
 ...
 g1_sky_picker_class::g1_sky_picker_class(i4_graphical_style_class *style,
    ...
    : i4_color_window_class(0,0, style->color_hint->neutral(), style),
      render_windows(0,32),eh(handler)
  {
...
class li_sky_change_button_class : public i4_button_class
{
public:
...
class li_g1_sky_initer:public i4_init_class
	{
	public:
                   ...
                   float r, float g, float b, float a)
{
  ...
  v[0].s=s;      v[0].t=t;
  v[1].s=s+0.5f;  v[1].t=t;
  v[2].s=s+0.5f;  v[2].t=t+0.5f;
  v[3].s=s;      v[3].t=t+0.5f;
}
...
{  
      ...
      g1_sky.update(*g1_get_map()->sky_name, window, use_blits))
  {
    ...
    if (use_blits)  
    {
      ...
      if (horz_cap > i4_pi_3_2()) horz_cap = 0;
      if (horz_cap > i4_pi_2())   horz_cap = i4_pi_2();
