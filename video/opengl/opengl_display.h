...
public:
	...
	virtual i4_bool input_exposed()
	{
		return i4_F;
	}                                           //usefull way to communicate special requests.
	...
	virtual char *name()
	{
		return "OpenGL display";
	}
	virtual i4_draw_context_class *get_context()
	{
		return context;
	}
	...
	{
		return fake_screen->width();
	}
	virtual w16 height() const
	{
		return fake_screen->height();
	}
