...
class i4_win32_opengl_display_class : public i4_opengl_display_class
{
public:
  virtual char *name() { return " OpenGL "; }
  ...
  i4_win32_opengl_display_class(char *message):input(message) {}
