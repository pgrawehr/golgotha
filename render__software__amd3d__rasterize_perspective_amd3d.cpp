...
void span_draw_perspective_lit_amd3d(span_tri_info * tri)
{
	...
	_asm
	{
		movd mm0,dword ptr [cur_grads] tri_gradients.dldx pf2id(m0, m0)
	...
	while (s!=global_span_list)
	{
		...
		_asm
		{
			...
			pi2fd(m0, _edi)
			movq mm1,qword ptr [eax] tri_gradients.dsozdx pfmul(m1, m0)
			movq mm2,qword ptr [eax] tri_gradients.dtozdx pfmul(m2, m0)
			movq mm4,qword ptr [eax] tri_gradients.sozat00 pfacc(m1, m2)
