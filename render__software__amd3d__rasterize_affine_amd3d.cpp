...
void span_draw_affine_unlit_amd3d(span_tri_info *tri)
{
	...
	_asm
	{
		...
		movd mm1,dword ptr [cur_grads] tri_gradients.dtdx pf2id(m0, m0)

		movd dword ptr [temp_dsdx],mm0 pf2id(m1, m1)
	...
	while (s!=global_span_list)
	{
		...
		_asm
		{
			...
			pi2fd(m0, _edi)
			movq mm1,qword ptr [eax] tri_gradients.dsdx pfmul(m1, m0)
			movq mm2,qword ptr [eax] tri_gradients.dtdx pfmul(m2, m0)
			movq mm4,qword ptr [eax] tri_gradients.sat00 pfacc(m1, m2)
...
void span_draw_affine_lit_amd3d(span_tri_info *tri)
{
	...
	_asm
	{
		movd mm0,dword ptr [cur_grads] tri_gradients.dsdx
		movd mm1,dword ptr [cur_grads] tri_gradients.dtdx pf2id(m0, m0)
		movd mm2,dword ptr [cur_grads] tri_gradients.dldx pf2id(m1, m1)
		movd dword ptr [temp_dsdx],mm0 pf2id(m2, m2)
		movd dword ptr [temp_dtdx],mm1
