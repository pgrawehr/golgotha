...
class i4_hashtable
	...
	class i4_hashtable_entry
		...
		friend class iterator;
		i4_hashtable_entry(){key=0;entry=0;flags=0;next=0;}
		...
		~i4_hashtable_entry(){};//don't do something weird here
		void set_next(i4_hashtable_entry *n){next=n;};
