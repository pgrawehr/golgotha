...
class r1_software_dd_class: public r1_software_class
	{
	...
	public:
		...
		char *name() {return "Software Renderer with ddraw";}
		~r1_software_dd_class();
...
class r1_software_gdi_class: public r1_software_class
	{
	protected:
	...
	public:
		...
		char *name() {return "Software Renderer with plain GDI";}
		~r1_software_gdi_class();
		i4_bool init(i4_display_class *display);
		void uninit();
		i4_bool resize(w16 new_width,w16 new_height);
...
class r1_software_dd_render_window_class : public r1_software_render_window_class
{
