...
renderer. 
*/
class r1_software_x11_class: public r1_software_class
	{
	...
	public:
		...
		char *name() {return "Software Renderer for X11";}
		~r1_software_x11_class();
...
class r1_software_x11_render_window_class : public r1_software_render_window_class
{
...
public: 
  ...
  char *name() { return "x11 software render window"; }
};
