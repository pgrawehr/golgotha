...
extern w32 mip_r_and;
extern w8 mip_r_shift;                       //r and g shifts are to the left
extern w32 mip_g_and;
extern w8 mip_g_shift;
extern w32 mip_b_and;
extern w8 mip_b_shift;                       //b shift is to the right

//chroma-key shifting info
extern w32 mip_c_r_and;
extern w8 mip_c_r_shift;                         //r and g shifts are to the left
extern w32 mip_c_g_and;
extern w8 mip_c_g_shift;
extern w32 mip_c_b_and;
extern w8 mip_c_b_shift;                         //b shift is to the right
extern w32 mip_c_a_and;
extern w8 mip_c_a_shift;                         //a shift is to the left

//alpha texture shifting info
extern w32 mip_a_r_and;
extern w8 mip_a_r_shift;                         //r and g shifts are to the left
extern w32 mip_a_g_and;
extern w8 mip_a_g_shift;
extern w32 mip_a_b_and;
extern w8 mip_a_b_shift;                         //b shift is to the right
extern w32 mip_a_a_and;
extern w8 mip_a_a_shift;                         //a shift is to the left
...
inline void remap_pixel(w16 *&dst, w8 *&src)
{
	...
	*dst = (w16)((((w16)src[0] << mip_r_shift) & mip_r_and) |
...
inline void chroma_remap_pixel(w16 *&dst, w8 *&src)
{
	...
	else
	{
		...
		*dst = (w16)((((w16)src[0] << mip_c_r_shift) & mip_c_r_and) |
...
inline void alpha_remap_pixel(w16 *&dst, w8 *&src)
{
	...
	//alpha bit(s) is set if its not transparent
	*dst = (w16)((((w16)src[1] << mip_a_r_shift) & mip_a_r_and) |
