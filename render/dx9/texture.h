...
#ifndef __R1_DX9_TEXTURE_HH__
#define __R1_DX9_TEXTURE_HH__

//#include <ddraw.h>
//#include <d3d.h>
#include "d3d9.h" //This is an uncommon solution, but reduces problems
				  //when distributed over the net: We include the dx9
				  //Headers in the distribution.
#include "memory/lalloc.h"
#include "render/tmanage.h"
#include "render/dx9/render.h"
#include "render/tex_no_heap.h"

class r1_dx9_texture_class : public r1_texture_manager_class
{
  friend r1_dx9_class;
...
public:  
  ...
  used_node *make_surfaces_for_load(IDirect3DTexture9 *&tex,
