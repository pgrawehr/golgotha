...
typedef struct _r1_vert //dont reorder this stuff
{
	...
	w8 flags;           // can be used for temporary storage
	w8 pad1;
	w8 pad2; //pad so its 8 bytes

	void set_color(i4_float _r, i4_float _g, i4_float _b, i4_float _a=1.)
	{
		r=_r;
		g=_g;
		b=_b;
	...
	void set_st(i4_float _s, i4_float _t)
	{
		s=_s;
		t=_t;
	}

	i4_3d_point_class *point()
	{
		return (i4_3d_point_class *)&v;
	}
