...
{
protected:
	i4_fixed_point(sw32 a, int dummy, int dummy2) :
		value(a)
	{
	}
	//{{{ Notes:
...
public:
	...
	i4_fixed_point(const sw32 r, const w32 f) :
		value((r<<precision) | (f>>(32-precision)))
	{
	}

	//{{{ Standard Type conversions
	i4_fixed_point(const int a) :
		value(sw32(a)<<precision)
	{
	}
	i4_fixed_point(const unsigned int a) :
		value(sw32(a)<<precision)
	{
	}
	i4_fixed_point(const sw8 a) :
		value(sw32(a)<<precision)
	{
	}
	i4_fixed_point(const w8 a) :
		value(sw32(a)<<precision)
	{
	}
	i4_fixed_point(const sw16 a) :
		value(sw32(a)<<precision)
	{
	}
	i4_fixed_point(const w16 a) :
		value(sw32(a)<<precision)
	{
	}
	i4_fixed_point(const sw32 a) :
		value(a<<precision)
	{
	}
	i4_fixed_point(const w32 a) :
		value(a<<precision)
	{
	}
	i4_fixed_point(const float a) :
		value(sw32(a*float (1<<precision)))
	{
	}
	i4_fixed_point(const double a) :
		value(sw32(a*double (1<<precision)))
	{
	}
	...
	operator sw8() const
	{
		return sw8(value>>precision);
	}
	operator w8() const
	{
		return w8(((w32)value)>>precision);
	}
	operator sw16() const
	{
		return sw16(value>>precision);
	}
	operator w16() const
	{
		return w16(((w32)value)>>precision);
	}
	operator sw32() const
	{
	...
	operator w32() const
	{
		return ((w32)value)>>precision;
	}
	operator double() const
	{
		return double (value)/double (1<<precision);
	}
	...
	{
		return DIRECT_CAST(value + b.value);
	}
	i4_fixed_point operator-(const i4_fixed_point b) const
	{
		return DIRECT_CAST(value - b.value);
	...
	i4_bool operator==(const i4_fixed_point b) const
	{
	...
	w32 get_fraction() const
	{
		return w32(value<<(32 - precision));
	}
	w32 get_precision() const
	{
		return precision;
	}
};
