...
public:
  ...
  i4_dvector3_template(const i4_dvector3_template& p) : x(p.x), y(p.y), z(p.z) {}
  i4_dvector3_template(const i4_3d_vector &p) : x(p.x), y(p.y), z(p.z) {}
  i4_dvector3_template(Coord _x,Coord _y,Coord _z) : x(_x),y(_y),z(_z) {}
...
public:
  ...
  i4_d2d_vector(const i4_2d_vector &from){x=from.x;y=from.y;};

  i4_d2d_vector(i4_double x, i4_double y) : x(x), y(y) {}

  i4_double length() const { return sqrt(x*x+y*y); }
  i4_double dot(const i4_d2d_vector &b)  { return x*b.x + y*b.y; }
  i4_double perp_dot(const i4_d2d_vector &b)  { return x*b.y-y*b.x; }

  i4_d2d_vector& operator-=(const i4_d2d_vector& b) { x-=b.x; y-=b.y; return *this; }
  i4_d2d_vector& operator+=(const i4_d2d_vector& b) { x+=b.x; y+=b.y; return *this; }
  i4_d2d_vector& operator*=(const i4_d2d_vector& b) { x*=b.x; y*=b.y; return *this; }
  i4_d2d_vector& operator/=(const i4_d2d_vector& b) { x/=b.x; y/=b.y; return *this; }
  
  i4_d2d_vector operator+(const i4_d2d_vector& b) { return i4_d2d_vector(x+b.x, y+b.y); }
  i4_d2d_vector operator-(const i4_d2d_vector& b) { return i4_d2d_vector(x-b.x, y-b.y); }
  i4_d2d_vector operator*(const i4_d2d_vector& b) { return i4_d2d_vector(x*b.x, y*b.y); }
  i4_d2d_vector operator/(const i4_d2d_vector& b) { return i4_d2d_vector(x*b.x, y*b.y); }
