...
class i4_poly_draw_gradient_class
{
	...
	fixed28_4 FloatToFixed28_4(i4_float Value)
	{
		return i4_f_to_i(Value * 16.f);
	}
	i4_float Fixed28_4ToFloat(fixed28_4 Value)
	{
		return Value / 16.0;
	}
	...
	sw32 FloatToFixed16_16(float Value)
	{
		return (sw32)(Value * 65536);
	}
...
//    int p_starty = (int)poly.vert[top].py;
	...
	void setup_edge(i4_polygon_class &poly, struct edge &edge, int end, class_with_needed_functions &c)
	{
		...
		if(edge.Height > 0)
		{
			i4_float yd=1.0f/(i4_float)edge.Height;
