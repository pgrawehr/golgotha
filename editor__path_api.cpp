...
static int sp_floor(i4_float val) { return i4_f_to_i(val); }
static int sp_ceil(i4_float val) { return 2048-i4_f_to_i(2048.0f-val); }
                                           ...
                                           i4_float rad_x, i4_float rad_y) const
{
  ...
  if (dist_y==0) // div by zero expected?
	  dx=0;
  else
