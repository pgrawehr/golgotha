...
li_object *m1_select_none(li_object *o, li_environment *env)
{
  ...
  if (m1_info.obj==NULL) return 0;//No object loaded, cannot unselect anything.
...
li_object *m1_select_similar(li_object *o, li_environment *env)
{
  i4_str *texture=0;
  int i,j;
  if (m1_info.obj==NULL) return 0; //useless command if no object loaded
...
class li_add_m1_commands_class: public i4_init_class
	{
