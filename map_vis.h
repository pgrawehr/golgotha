...
public:
	...
	{
		return i4_T;
	}                                   // do you want w value for each pixel write? (1/z)
	i4_bool do_st()
	{
		return i4_F;
	}                                   // do you want texture coordinates?
	int do_light()
	{
		return 0;
	}                                   // return 0 for no light
	i4_bool do_p()
	{
		return i4_F;
	}                                   // no perspective
...
public:
		...
		screen_pointer &operator+=(int v)
		{
			x+=v;
			return *this;
		}
		void next_line(g1_visible_projection &vp)
		{
			y++;
		}
