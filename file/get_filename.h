...
class i4_file_open_message_class :
...
public:
	...
	virtual i4_event *copy()
	{
		if (filename)
		{
			return new i4_file_open_message_class(sub_type,
												  new i4_str(*filename));
		}
		else
		{
			return new i4_file_open_message_class(sub_type,0);
		}
	}
