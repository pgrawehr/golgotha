...
class i4_temp_file_class : public i4_file_class
	{
...
//growth of the file
	...
	public:
		...
		virtual w32 size(){return fs;}
		virtual w32 tell(){return offset;};
		virtual ~i4_temp_file_class();
		void clear(){offset=0;fs=0;};
		w8 *get_buffer(){return buf;};//usefull in conjunction with network support
	};
