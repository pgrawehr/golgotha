...
class i4_text_change_notify_event :
...
public:
	...
	{
		return new i4_text_change_notify_event(object, new_text);
	}
	virtual dispatch_time when()
	{
		return NOW;
	}
	~i4_text_change_notify_event()
	{
		delete new_text;
	}
};
...
class i4_query_text_input_class :
	public i4_query_message_event_class
{
public:
...
public:
	...
	{
		return st;
	}                                               // don't delete this return string!
	char *getValue()
	{
		i4_os_string(*st,textbuf,512);
		return textbuf;
	};
