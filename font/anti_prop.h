...
class i4_anti_proportional_font_class :
...
public:
	...
	virtual w16 width(const i4_char &character)
	{
		return widths[character.ascii_value()];
	}
	virtual w16 height(const i4_char &character)
	{
		return h;
	}
	...
	virtual w16 height(const i4_const_str &string)
	{
		return h;
	}

	virtual w16 largest_height()
	{
		return h;
	}
	virtual w16 largest_width()
	{
		return longest_w;
	}
