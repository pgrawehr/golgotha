...
#ifndef DS_ERROR_H_INC
#define DS_ERROR_H_INC
#include "file/file.h"
...
//{{{
{
  ...
  i4_warning("DirectSound Problem: ");
  switch (err)
  {
    case DSERR_ACCESSDENIED: 
		  i4_warning( " The call failed because access was denied.");
		  break;
    ...
    case DSERR_NOINTERFACE:
      ...
      break;      
	//case DSERR_HWUNAVAIL: //Directsound 7
	//	i4_warning( " The DirectSound Hardware is currently unavailable.");
	//	break;
	default:
		i4_warning( "An unknown error occured");
		break;
  }
  return 0;
}
