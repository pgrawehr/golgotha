...
public:
	...
	virtual i4_voice_class *alloc(w32 buffer_size, sound_parameters &description)
	{
		return 0;
	}
	...
	virtual i4_bool is_enabled()
	{
		return enabled;
	}
	virtual void enable_sound()
	{
		enabled=i4_T;
	};
	virtual void disable_sound()
	{
		enabled=i4_F;
	}
	virtual i4_bool toggle_sound()
	{
		enabled=!enabled;
		return enabled;
	}
