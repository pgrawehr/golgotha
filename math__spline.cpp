...
public:
	...
	i4_1x4_vector(i4_float x, i4_float y, i4_float z, i4_float t) :
		x(x),
		y(y),
		z(z),
		t(t)
	...
	i4_float dot(const i4_1x4_vector &b)
	{
		return b.x*x + b.y*y + b.z*z + b.t*t;
	}
...
class i4_bspline_basis :
	public i4_4x4_matrix_class
{
public:
	i4_bspline_basis()
	{
