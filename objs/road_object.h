...
class g2_breadth_first_road_solver_class : public g1_graph_solver_class, public i4_init_class
{
public:
  class solve_node
  {
  public:
    ...
    solve_node() {}
	//for dy
    solve_node(g1_road_object_class *node, i4_float length) : nref(node), length(length) {weight=length;}
	solve_node(g1_road_object_class *node, i4_float length, i4_float weight): 
	  nref(node), length(length), weight(weight){}
...
protected:
  ...
  virtual void clear_heap() { heap.clear(); }
  void init(){
	  nodes=0;
	  }
...
public:
  ...
  g2_breadth_first_road_solver_class() : heap(0,200){}
  ...
  i4_bool path_solve_nodes(g1_graph_node start_node, g1_graph_node end_node, 
	  ...
	  {points=0;return i4_F;};//this solver is not applicable like this
...
class g2_astar_road_solver_class: public g2_breadth_first_road_solver_class
	{
	protected:
...
class g1_road_object_class: public g1_path_object_class
	{
	protected:
		w32 last_path_tick;
