...
public:
	...
	g1_stank_ammo_info_struct ammo[MAX_WEAPONS+1];     // 0=main, 1=missiles, 2=chain, 3=health
	// The additional entry is used as 'garbage can' to skipload()
	void find_weapons();
	...
	//w32 follow_path();
	enum {
		MV_OK,MV_CORRECTED,MV_CANNOTCONT
	};
	int move(i4_float x_amount, i4_float y_amount);
