...
public:
	...
	virtual void fire();
	void think();
	void setup(i4_float x, i4_float y, g1_object_class * creator);

	i4_bool deploy_to(float x, float y, g1_path_handle ph);

	i4_bool occupy_location()
	{
		int ret=g1_object_class::occupy_location_model(draw_params);
