...
public:
	...
	{
		return obj[id&ID_MASK];
	}
	g1_object_class *checked_get(w32 id)
	{
		return check_id(id) ? get(id) : 0;
	}
...
public:
		w32 &operator[](w32 id)
		{
			return map[id&ID_MASK];
		}
	};
	remapper *alloc_remapping()
	{
...
public:
	...
	{
		return g1_global_id.checked_get(id);
	}
	i4_bool valid()
	{
		return g1_global_id.check_id(id);
	}
	g1_id_ref()
	{
		id=0;
 ...
 */
	...
	g1_id_ref& operator=(const g1_id_ref &r)
	{
		id=r.id;
		return *this;
	}
	g1_id_ref& operator=(w32 _id)
	{
		id=_id;
		return *this;
	}
