...
//for old files.
class g1_realtime_saver_class :
	public g1_saver_class
{
public:
...
public:
	...
	i4_bool references_were_loaded()
	{
		return first_ref!=0;
	}
...
class g1_realtime_loader_class :
	public g1_loader_class
{
public:
