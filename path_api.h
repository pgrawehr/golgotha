...
enum g1_compass_direction { G1_NORTH=1, G1_SOUTH=2, G1_WEST=4, G1_EAST=8, G1_ALL_DIRS=15 };
...
public:
  ...
  g1_block_map_class() : block_map(0) {wx=0;wy=0;bwx=0;}
  g1_block_map_class(w16 _wx, w16 _wy) { block_map=0;init(_wy,_wy); }
