...
public:
	...
	};                                        // this state is so we don't miss a button between
											  // frames
private:
...
public:
	...
	void commands_are_for_player(g1_player_type pl)
	{
		command_player_num=pl;
	}
	...
	char *grab_cheat_keys()
	{
		return cheat_code_buffer;
	}
	void  clear_cheat_keys()
	{
	...
	i4_bool strafe_active()
	{
		return (i4_bool)(in[STRAFE_MODIFIER]);
	}
	i4_bool strafe_left()
	{
		return (i4_bool)(in[STRAFE_LEFT]  || (in[LEFT] && strafe_active()));
	}
	i4_bool strafe_right()
	{
		return (i4_bool)(in[STRAFE_RIGHT] || (in[RIGHT] && strafe_active()));
	}

	i4_bool left()
	{
		return (i4_bool)(in[LEFT] && !strafe_active());
	}
	i4_bool right()
	{
		return (i4_bool)(in[RIGHT] && !strafe_active());
	}
	i4_bool up()
	{
		return in[UP];
