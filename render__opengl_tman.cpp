...
void r1_opengl_texture_manager_class::teximage2d(used_node *u)
	...
	if (u->texformatflags & R1_OPENGL_TEXFORMAT_HOLY) { // holy texture - 1555
	...
	else if (u->texformatflags & R1_OPENGL_TEXFORMAT_ALPHA) { // alpha texture - 4444
