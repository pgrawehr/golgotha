...
inline i4_float m1_near_clip_z() { return r1_near_clip_z+0.1f; }
...
//{{{
{
  ...
  switch (ev->type())
  {
    ...
    case i4_event::KEY_PRESS:
    {
      ...
      switch (kev->key) 
      {
        case I4_LEFT  : pan(-0.05f,0.0f); break;
        case I4_RIGHT : pan(0.05f,0.0f); break;
        case I4_UP    : pan(0.0f,-0.05f); break;
        case I4_DOWN  : pan(0.0f,0.05f); break;
