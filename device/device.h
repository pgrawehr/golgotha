...
template <class T>
class i4_event_handler_reference_class :
	public i4_event_handler_private_reference_class
{
public:
	T *get()
	{
...
public:
	...
	i4_bool thinking()
	{
		return (i4_bool)(call_stack_counter!=0);
	}
...
public:
	...
	enum
	{
		...
		FLAG_CHAR_SEND           = 4096,
		FLAG_USER_MESSAGE        = 8192, //for anything else (i.e debug-messages)
