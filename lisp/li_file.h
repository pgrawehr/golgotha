...
class li_file : public li_object
{
protected:
  i4_file_class *fp;
public:
  li_file(i4_file_class *f) : li_object(li_file_type), fp(f) {};
  li_file():li_object(li_file_type), fp(0){};


  i4_file_class *value() { return fp; }  //don't use references with files
  ...
  { check_type(o, li_file_type, env); return ((li_file *)o); }
} ;
